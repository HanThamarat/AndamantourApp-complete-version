        ...
        <div class="table-card">
            ...
            <div class="table-container">
                <table class="myTable stripe">
                    <thead>
                        <?php
                            $stmt = $conn->query("SELECT * ,CONCAT(firstName, ' ', lastName) AS concatName FROM ((reserve INNER JOIN packages ON reserve.packID = packages.packID) INNER JOIN packagestype ON packages.packtypeID = packagestype.packagesTypeId) WHERE status_cancel = '1'");
                            $stmt->execute();
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="detail-btn">
                                        <a href="<?php echo "{$domain}Admin/pages/reserve/cancelBooking/cancelDetail.php?id=$ad_id&reserveID=$reserveID"?>">
